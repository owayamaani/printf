...
**Project Description**
---
 _printf replicates the C standard library printf() function.<br>
...
+ The prototype is called this way: _printf("format string", arguments...) where format string can contain conversion specifiers and flags, along with other regular characters<br>

**Examples**<br>
---
+ ```_printf("Programming in ALX\n")``` prints "Programming in ALX", followed by a new line<br>
+ ```_printf("This is a number: %d", 1001)``` prints "This is a number: 1001"<br>
...
**Ashley Owaya:** https://github.com/owayamaani
<br>
**Elvis Olesso:** https://github.com/olesso
